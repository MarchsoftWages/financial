...
<style>
     ...
     */
    body{
        background: url(/img/error/bg1.png);
...
<div class="wrap">
    ...
    <!--start-content------>
    <div class="content">
        <img src="/img/error/error-img.png" title="error" />
        <p><span><label>O</label>hh.....</span>页面丢失了......</p>
        <a href="#">Back To Home</a>
        <div class="copy-right">
            <p>&#169 All rights Reserved | <a href="http://www.marchsoft.cn/">三月软件</a></p>
        </div>
    </div>
    <!--End-Cotent------>
</div>
